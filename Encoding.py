...
def AA_encoding(input_dir,save_dir,dataset,encoding):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir',help="Directory for Input Files (directory for xlsx files for combinatorial library)",default='Input/')
    ...
    AA_encoding(input_dir,save_dir, dataset, encoding)
